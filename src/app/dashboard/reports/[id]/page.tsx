...
export default function ReportDetailPage({
  ...
  function sendToClient() {
    if (!publicUrl || !report) return;
    const subject = encodeURIComponent("WatchFlowing weekly intelligence report");
    const body = encodeURIComponent(
      [
        "Sharing our latest website intelligence report.",
        "",
      ...
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3 print:hidden">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button
            ...
            disabled={!publicUrl}
            className="inline-flex min-h-11 items-center gap-2 rounded-full border border-white/[0.08] px-4 text-xs text-zinc-300 hover:border-cyan-400/25 disabled:opacity-40"
          >
            Send to client
          </button>
          <button
          ...
          >
            ...
            {report.shareEnabled ? "Sharing on" : "Share report"}
          </button>
        </div>
      </div>
